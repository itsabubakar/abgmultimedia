...
const Navbar = () => {
    ...
    return (
        <div className={nav ? "relative left-0 top-0 w-full z-10 ease-in-out duration-100" : "bg-black py-5 relative left-0 top-0 w-full z-10 ease-in-out duration-100"}>
            <div className="px-5 md:px-24 flex items-center justify-between">
                ...
                <div className={nav ? "fixed top-0 left-0 right-0 bottom-0 flex flex-col items-center w-full h-screen bg-black text-white  pt-7 ease-in-out duration-100" : 'hidden top-0 left-[100%] right-0 bottom-0 flex-col items-center w-full h-screen bg-black text-white  pt-[50px] ease-in-out duration-100'}>
                    <div className='mb-4 ml-auto mr-[30px]' onClick={() => setNav(!nav)}>
                        <AiOutlineClose size={30} className="text-white border-2 rounded p-1" />
                    </div>
